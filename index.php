    ...
    <div class="row">
        ...
        <tbody>
            <tr>
                ...
                <td>&#8377; {{price.BTC.EUR | number:2}} <span>({{price.BTC.EUR_ORI | number:4}} &euro;)</span> <i class="ui mini label teal horizontal">CEX</i></td>
            ...
            <tr>
                ...
                <td>&#8377; {{price.BCH.EUR | number:2}} <span>({{price.BCH.EUR_ORI | number:4}} &euro;)</span> <i class="ui mini label teal horizontal">CEX</i></td>
            ...
            <tr>
                ...
                <td>&#8377; {{price.XRP.EUR | number:2}} <span>({{price.XRP.EUR_ORI | number:4}} &euro;)</span> <i class="ui mini label teal horizontal">CEX</i></td>
            ...
            <tr>
                ...
                <td>&#8377; {{price.ETH.EUR | number:2}} <span>({{price.ETH.EUR_ORI | number:4}} &euro;)</span> <i class="ui mini label teal horizontal">CEX</i></td>
            ...
            <tr>
                <td><div class="ui ribbon label silver">XLM <i class="rocket icon"></i></div></td>
                <td>&#8377; {{price.XLM.USD | number:2}} <span>({{price.XLM.USD_ORI | currency}})</span> <i class="ui mini label teal horizontal">CEX</i></td>
                <td>&#8377; {{price.XLM.EUR | number:2}} <span>({{price.XLM.EUR_ORI | number:4}} &euro;)</span> <i class="ui mini label teal horizontal">CEX</i></td>
                <td></td>
                <td></td>
            ...
            <tr>
                ...
                <td>&#8377; {{price.DASH.EUR | number:2}} <span>({{price.DASH.EUR_ORI | number:4}} &euro;)</span> <i class="ui mini label teal horizontal">CEX</i></td>
                <td></td>
                <td></td>
